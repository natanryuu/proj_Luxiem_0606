            ...
            <div class="design-self">
                <div class="design-hold-item">
                    ...
                    <table class="order_table">
                        <thead>
                            <!-- 訂單清單標題 -->
                            <tr class="order-check-table-title">
                                    ...
                                    <tr data-sid="<?= $d['order_sid'] ?>">
                                        <td class="order_content_left">
                                            <div class="item-follow-item-imgwrap">
                                                <img style="width:80px" src="./imgs/Itemshop/Avatar_item/<?= $d['item_img'] ?>" alt="">
                                            </div>
                                        </td>
                                        <td class="order_content_middle">
                                                <div> <span>Luca</span> <?= $d['item_name'] ?></div>
                                                <div> <span>繪師</span> <?= @$d['item_author'] ?></d>
                                                <div> <span>類型</span> <?= $d['item_type'] ?></div>
                                        </td>
                                        <td>
                                            <div class="golden_price">
                                                <svg width="12" height="12" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
